 ...
 * [WhiteNoise](#nn.WhiteNoise) : Adds isotropic Gaussian noise to the signal. Useful in training [Denoising Autoencoders] (http://arxiv.org/pdf/1507.02672v1.pdf). Take mean and standard deviation of the Gaussian as input. Default values for mean and standard deviation are 0 and 0.1 respectively.
